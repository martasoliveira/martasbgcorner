...
{{< figure
  ...
  alt="BG Stats April 2026"
  width="400"
  caption="April 2026 stats"
>}}

{{< figure
  src="all-games-april-2026.png"
  alt="All games played in April 2026"
  width="400"
  caption="All games played in April 2026"
>}}
...
{{< figure
  src="onirim.jpg"
  alt="Onirim cards laid out on the table"
  width="500"
  caption="Onirim: escaping the labyrinth one card at a time"
>}}
...
{{< figure
  src="red-rising.jpg"
  alt="Red Rising game in progress"
  width="500"
  caption="Red Rising: so many strategies to explore"
>}}
...
{{< figure
  ...
  width="500"
  caption="It's a Wonderful World: the engine runs beautifully, winning is another matter"
>}}
...
{{< figure
  src="escape.jpg"
  alt="Escape: The Curse of the Temple in full chaotic action"
  width="400"
  caption="Escape: The Curse of the Temple: beautiful pandemonium at four players"
>}}
...
{{< figure
  ...
  alt="Era of Kingdoms cards and board"
  width="500"
  caption="Era of Kingdoms: a very pleasant surprise"
>}}
...
{{< figure
  src="outlive.jpg"
  alt="Outlive game in progress"
  width="500"
  caption="Outlive: worth the wait"
>}}
...
{{< figure
  src="7-sea.jpg"
  alt="Side Quest: 7th Sea puzzle cards and components"
  width="500"
  caption="Side Quest: 7th Sea: smooth start, trickier finish"
>}}
...
{{< figure
  ...
  width="400"
  caption="Fromage: the most thematic worker placement you'll find"
>}}
...
{{< figure
  src="paper-tales.jpg"
  alt="Paper Tales tableau and cards"
  width="500"
  caption="Paper Tales: mixed first impressions, but the concept is good"
>}}
...
{{< figure
  ...
  alt="Dice Throne Adventure scenario 3"
  width="500"
  caption="Dice Throne Adventure: scenario 3, the one I actually won first try!"
>}}

{{< figure
  src="dice-throne-adventure-scenario-4.jpg"
  alt="Dice Throne Adventure scenario 4"
  width="500"
  caption="Dice Throne Adventure: scenario 4, the campaign continues"
>}}
...
{{< figure
  ...
  alt="Ancient Knowledge cards and board in play"
  width="500"
  caption="Ancient Knowledge: still searching for that winning recipe"
>}}

### Viticulture

Have I mentioned that I love [Viticulture](https://www.martasbgcorner.com/en/posts/20260416-viticulture/)? Because I really love Viticulture. Solo, every single point counts. One wrong decision and the win slips away. I'm genuinely curious to explore the Tuscany and Bordeaux expansions at some point. Something to look forward to.

{{< figure
  src="viticulture.jpg"
  alt="Viticulture board and components"
  width="400"
  caption="Viticulture: every point counts"
>}}
...
What a month it's been! New groups, new games, old favourites. April had it all. Are any of these games on your radar? Have you played any of them? Come share your thoughts on **[Mastodon](https://mastodon.social/@martasbgcorner/116507583038584126)**.
