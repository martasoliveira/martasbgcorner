...
{{< figure
  src="view.jpg"
  alt="R.A.V.E.L. components overview"
  width="350"
  caption="R.A.V.E.L. components overview"
>}}
...
{{< figure
  src="setup.jpg"
  alt="R.A.V.E.L. setup ready to play"
  width="350"
  caption="R.A.V.E.L. setup ready to play"
>}}
...
{{< figure
  ...
  alt="Cards with all conditions satisfied"
  width="400"
  caption="Cards with all conditions satisfied"
>}}
...
{{< figure
  ...
  alt="Cards and their higher difficulty versions. Top row: for the basic card, the 3 dice must show the same number; for the higher difficulty card, the dice must also be different colors."
  width="350"
  caption="Cards and their higher difficulty versions. Top row: for the basic card, the 3 dice must show the same number; for the higher difficulty card, the dice must also be different colors."
>}}
...
{{< figure
  src="game-lost-1.jpg"
  alt="Final game state with 2 Cog cards unsolved"
  width="350"
  caption="Final game. 2 Cog cards not solved so game over 🥲"
>}}
...
- [One Stop Co-op Shop - great solo playthrough](https://youtu.be/z6qyu_oud4o?si=mLp62hpGEP8Dq9vV)
