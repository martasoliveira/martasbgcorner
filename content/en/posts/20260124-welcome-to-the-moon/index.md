...
1. **Learning mode** – Guides you through each adventure, as each has unique rules. The core mechanics remain the same, but the sheet designs mean numbers are placed differently.
2. **Campaign mode** – A connected narrative where each result influences the next adventure. Cards are hidden and revealed during gameplay, creating an evolving story.

{{< figure
  src="end-of-adventure-1.jpg"
  alt="End of Adventure 1"
  width="350"
  caption="End of Adventure 1"
>}}
...
{{< figure
  src="components.jpg"
  alt="Welcome to the Moon components"
  width="350"
  caption="Components"
>}}
...
{{< figure
  ...
  alt="Setup for Adventure 3"
  width="500"
  caption="Setup for Adventure 3"
>}}
...
* [Solooperative Games](https://youtu.be/yvB3RR7xxwQ?si=YIaDCTnuaXu1dqSX) - Solo playthrough of the Adventure 1
