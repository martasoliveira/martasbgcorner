...
tags = ['Solo Gaming', 'Worker Placement', 'Hand Management', 'Euro Game']
games = ['Viticulture']
...
{{< figure
  ...
  alt="Viticulture Essential Edition box"
  width="500"
  caption="Viticulture Essential Edition box"
>}}
...
{{< figure
  ...
  alt="Vines planted in fields"
  width="500"
  caption="Vines planted in fields"
>}}
...
{{< figure
  ...
  alt="Main board"
  width="500"
  caption="Main board - from left to right: Spring track, Summer yellow actions, Autumn cards draw and Winter blue actions"
>}}
...
{{< figure
  ...
  alt="Player board"
  width="500"
  caption="Player board and Mama and Papa cards"
>}}
...
{{< figure
  ...
  alt="Box content"
  width="400"
  caption="Box content and insert"
>}}
...
{{< figure
  ...
  alt="End of game"
  width="400"
  caption="Boards at the end of the game"
>}}
...
Have you played Viticulture? Do you prefer it solo or with others, and have you taken the leap into Tuscany yet? Come share your thoughts on **[Mastodon](https://mastodon.social/@martasbgcorner/116414672829835141)**.
...
- [Viticulture Essential edition in about 3 minutes](https://youtu.be/VtYSzcWdUDU?si=QMPbPAC7MESLPzDp) - Quick explanation of the game by 3 Minute Board Games
- [Viticulture - How To Play](https://youtu.be/L5fcDctkFFE?si=9tRGSgDlTJ_a8MtF) - Rules explanation by Watch It Played
- [Viticulture | Automa (Solo) Playthrough](https://youtu.be/IbjwyTa70dU?si=-Rl6H5Q6A3-QzxKV) - Great solo playthrough by slickerdrips