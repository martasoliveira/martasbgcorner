...
tags = ['Solo Gaming', 'Hand Management']
games = ['Obsession']
...
{{< figure
  ...
  alt="Obsession game boards"
  width="500"
  caption="Obsession game boards"
>}}
...
{{< figure
  ...
  alt="Setup for one player"
  width="500"
  caption="Setup for one player"
>}}
...
{{< figure
  ...
  alt="Reputation wheel and available servants"
  width="500"
  caption="Reputation wheel and available servants"
>}}
...
{{< figure
  ...
  alt="Country estate improvements at the end of the game"
  width="500"
  caption="Country estate improvements at the end of the game"
>}}
...
{{< figure
  ...
  alt="Courtship events. In this example 2 Essentials, 1 Sporting and 1 Prestige"
  width="500"
  caption="Courtship events. In this example 2 Essentials, 1 Sporting and 1 Prestige"
>}}
...
{{< figure
  ...
  alt="Big bag to shuffle the tiles"
  width="350"
  caption="Big bag to shuffle the tiles"
>}}
...
{{< figure
  ...
  alt="Solo automa material"
  width="350"
  caption="Solo automa material"
>}}
...
- [Unna – Obsession playthrough – Spanish reviewer with a fantastic playthrough](https://youtu.be/F1ubiA2qZOI?si=-WRf3QgzYm9xB0-f)
- [One Stop Coop Shop – Great solo playthrough](https://youtu.be/6Gjs_UjUHDY?si=VG9urXsYchUi9riK)