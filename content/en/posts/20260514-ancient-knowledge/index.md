...
tags = ['Solo Gaming', 'Tableau Building', 'Hand Management', 'Open Drafting']
...
{{< figure
  ...
  alt="Ancient Knowledge box"
  width="500"
  caption="Ancient Knowledge box"
>}}

{{< figure
  src="ancient-knowledge-heritage.jpg"
  alt="Ancient Knowledge Heritage box"
  width="500"
  caption="Ancient Knowledge: Heritage expansion box"
>}}
...
{{< figure
  ...
  alt="Cards from the Ancient Knowledge collection"
  width="500"
  caption="Cards from the Ancient Knowledge collection"
>}}
...
{{< figure
  ...
  alt="Technology cards on display"
  width="500"
  caption="Technology cards on display"
>}}
...
{{< figure
  ...
  alt="The back of the board, showing the artwork"
  width="400"
  caption="The back of the board, showing the artwork"
>}}

{{< figure
  src="ancient-knowledge-setup.jpg"
  alt="Game setup ready to play"
  width="500"
  caption="Game setup ready to play"
>}}
...
{{< figure
  ...
  alt="End of game overview"
  width="500"
  caption="End of game overview"
>}}
...
Ancient Knowledge is all about passing knowledge through time. How about you: have you played it? Are you working through the Heritage campaign, and how many objectives have you completed so far?  Come share your thoughts on **[Mastodon](https://mastodon.social/@martasbgcorner/116575178864013914)** and **[Facebook](https://www.facebook.com/profile.php?id=61579559053699)**.

### Related Links

- [Ancient Knowledge on BoardGameGeek](https://boardgamegeek.com/boardgame/338093/ancient-knowledge)
- [Ancient Knowledge: Heritage on BoardGameGeek](https://boardgamegeek.com/boardgame/404354/ancient-knowledge-heritage)
- [Iello official page](https://iellogames.com/games/ancient-knowledge/)

### Videos

- [Ancient knowledge in about 3 minutes](https://youtu.be/LnSWaVxm25o?si=ZtDkZv-GjDSLICG7) - Game presentation by 
3 Minute Board Games
- [Ancient Knowledge: Heritage - Straight Up Solo with John LaRuffa](https://youtu.be/fb18nNCHiAc?si=nohFevLjOPcFXWFi) - Solo playthrough by John LaRuffa
