...
tags = ['Solo Gaming', 'Multiplayer', 'Hand Management', 'Tableau Building', 'Open Drafting', 'Small Games']
games = ["It's a Wonderful World", 'Ancient Knowledge', 'Fromage', 'Fromaggio', 'Time Bomb', 'Broom Service', 'Onirim', 'Codenames', 'Age of Civilization', 'Suburbia', 'Ohio Bob']
+++
...
{{< figure
  ...
  alt="BG Stats May 2026"
  width="400"
  caption="May 2026 stats"
>}}

{{< figure
  src="all-games-may-2026.png"
  alt="All games played in May 2026"
  width="500"
  caption="All games played in May 2026"
>}}
...
{{< figure
  ...
  alt="It's a Wonderful World tableau"
  width="500"
  caption="It's a Wonderful World: the satisfaction of a perfectly constructed engine"
>}}

## Ancient Knowledge

I already have a [full review of Ancient Knowledge](https://www.martasbgcorner.com/en/posts/20260514-ancient-knowledge/) on the blog, so I won't go into detail here. The short version: you're the architect of ancient wonders, and the real heart of the game is deciding when to spend your cards and how to manage where they enter the timeline. Should you push a monument closer to the past, or keep it in play a little longer? That tension is what makes the game tick.
...
{{< figure
  ...
  alt="Ancient Knowledge cards and monuments"
  width="500"
  caption="Ancient Knowledge: managing the flow of time"
>}}
...
{{< figure
  src="fromage.jpg"
  alt="Fromage board and components"
  width="400"
  caption="Fromage: more cheese strategies than you'd expect"
>}}

{{< figure
  src="formaggio.jpg"
  alt="Formaggio board and components"
  width="400"
  caption="Formaggio: same great cheese, a little more variety"
>}}
...
{{< figure
  src="time-bomb.jpg"
  alt="Time Bomb cards laid out"
  width="500"
  caption="Time Bomb: two teams, one bomb, no one tells the truth"
>}}
...
{{< figure
  ...
  alt="Broom Service game in progress"
  width="400"
  caption="Broom Service: brave or cowardly? Choose wisely"
>}}

### Onirim

I already have a [full review on the blog](https://www.martasbgcorner.com/en/posts/20260527-onirim/). Onirim is a game I love, and it reminds me of classic solitaire card games. Fair warning: if you're not a fan of shuffling, this one might test your patience. You'll be doing it often. Absolutely worth it.

My rating: **8/10** — as in the review. A perfect everyday game that never overstays its welcome.

{{< figure
  src="onirim.jpg"
  alt="Onirim cards laid out"
  width="500"
  caption="Onirim: one more game, always"
>}}
...
{{< figure
  ...
  alt="Age of Civilization cards and board"
  width="500"
  caption="Age of Civilization: timing is everything"
>}}
...
{{< figure
  src="suburbia.jpg"
  alt="Suburbia city tiles laid out"
  width="500"
  caption="Suburbia: great puzzle, frustrating rules"
>}}
...
{{< figure
  src="ohio-bob.jpg"
  alt="Ohio Bob cards laid out"
  width="500"
  caption="Ohio Bob: small box, clever challenge"
>}}
...
May had a nice mix of familiar favourites and new discoveries. It's a Wonderful World continues to be one of those games I simply can't put down, and Fromage turned out to be a real treat. Have you played any of these? I'd love to hear your thoughts! Come find me on [Mastodon](https://mastodon.social/@martasbgcorner/116720071302234300) and [Facebook](https://www.facebook.com/profile.php?id=61579559053699).
