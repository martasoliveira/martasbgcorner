...
tags = ['Solo Gaming', 'Deck Building', 'Hand Management', 'Worker Placement']
games = ['Legacy of Yu']
...
{{< figure
  ...
  alt="Legacy of Yu box"
  width="500"
  caption="Legacy of Yu box"
>}}
...
{{< figure
  ...
  alt="Close-up of the board showing worker colour equivalence icons and Outpost buildings"
  width="500"
  caption="The worker equivalence system: Outposts let you treat different worker colours as interchangeable, which opens up real flexibility when resources are tight"
>}}
...
{{< figure
  ...
  alt="Legacy of Yu main board showing the Flood, Barge, canal cards and buildings mid-game"
  width="500"
  caption="The board at the start of the game: the blue Flood creeps from the left, the red Barge sits on the next canal section to build, and Farms and Outposts fill the settlement below"
>}}
...
{{< figure
  ...
  alt="Legacy of Yu box insert with all components organised in labelled sections"
  width="500"
  caption="The insert keeps everything organised and doubles as in-game storage"
>}}

{{< figure
  src="legacy-of-yu-setup.jpg"
  alt="Legacy of Yu full game setup seen from above with box in the background"
  width="500"
  caption="Full setup ready to play – everything slots neatly into place"
>}}
...
{{< figure
  ...
  alt="Legacy of Yu game in progress with cards in hand and Story Book visible on the right"
  width="500"
  caption="Cards in hand, Story Book at the ready – every round brings a new decision to make"
>}}
...
{{< figure
  ...
  alt="Legacy of Yu box and game setup"
  width="500"
  caption="Legacy of Yu – worth every restart"
>}}

## Your Turn

Have you played Legacy of Yu? I would love to know how your campaign went, and whether you ever caught yourself playing a rule wrong and sailing through the game a little too smoothly. Come share them on **[Mastodon](https://mastodon.social/@martasbgcorner/116806969572263982)** and **[Facebook](https://www.facebook.com/profile.php?id=61579559053699)**.
  
### Related Links

- [Legacy of Yu on BoardGameGeek](https://boardgamegeek.com/boardgame/354934/legacy-of-yu)
- [Garphill Games website](https://garphill.com/game-store/legacy-of-yu)

### Videos

- [Legacy of Yu in about 3 minutes](https://youtu.be/DRgsPZTQU_o?si=zUIz6MoGo5m3dEQS) - An excellent 4 minutes presentation of the game by 3 Minute Board Games
- [Legacy of Yu Board Game | Spoiler Free Tutorial and Full Solo Playthrough](https://youtu.be/FfMFlYfV8y8?si=rU0WWuIB2xjTd4bk) - Playthrough from Totally Tabled
- [Legacy of Yu Board Game | Solo Series | Playthough and Impressions](https://youtu.be/e_qwhQhsCo8?si=jTx8Ph6q6Si0uyXI) - Playthrough from Ant Lab Games