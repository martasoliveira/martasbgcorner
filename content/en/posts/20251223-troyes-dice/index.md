...
date = '2025-12-23'
draft = false
title = "Troyes Dice: A Medieval Roll & Write"
description = "My review of Troyes Dice, a medieval roll-and-write where you draft dice to build a city, quick to play, with real strategic bite."
author = "martas.bg.corner"
image = 'box-2.jpg'
categories = ['Board Games', 'Reviews']
tags = ['Solo Gaming', "Roll & Write", 'BYOS']
games = ['Troyes Dice']
...
{{< figure
  src="material-1.jpg"
  alt="Troyes Dice components"
  width="400"
  caption="Troyes Dice components"
>}}
...
{{< figure
  ...
  alt="Expansion end game example"
  width="350"
  caption="Expansion end game example"
>}}
...
{{< figure
  src="end-game.jpg"
  alt="End game example"
  width="250"
  caption="End game example"
>}}
...
- [Before You Play – Playthrough and Review](https://youtu.be/WsN1L2gYeEs?si=3IPcWaIJGJO_KyQf)