...
tags = ['Jeu en Solo', 'Tableau Building', 'Hand Management', 'Open Drafting']
...
{{< figure
  src="ancient-knowledge-box.jpg"
  alt="Boîte d'Ancient Knowledge"
  width="500"
  caption="La boîte d'Ancient Knowledge"
>}}

{{< figure
  src="ancient-knowledge-heritage.jpg"
  alt="Boite d'Ancient Knowledge: Heritage"
  width="500"
  caption="Boite de l'extension d'Ancient Knowledge: Heritage"
>}}
...
{{< figure
  src="ancient-knowledge-technology.jpg"
  alt="Les cartes Technologie disponibles"
  width="500"
  caption="Les cartes Technologie disponibles"
>}}
...
{{< figure
  src="ancient-knowledge-back-board.jpg"
  alt="Le verso du plateau, avec son illustration"
  width="400"
  caption="Le verso du plateau, avec son illustration"
>}}

{{< figure
  src="ancient-knowledge-setup.jpg"
  alt="La mise en place prête à jouer"
  width="500"
  caption="La mise en place prête à jouer"
>}}
...
{{< figure
  src="ancient-knowledge-end-of-game.jpg"
  alt="Vue d'ensemble en fin de partie"
  width="500"
  caption="Vue d'ensemble en fin de partie"
>}}
...
Ancient Knowledge est avant tout une question de transmission du savoir à travers le temps. Et vous, vous y avez joué ? Êtes-vous en train de progresser dans la campagne Heritage, et combien d'objectifs avez-vous accomplis jusqu'ici ? Venez partager vos impressions sur **[Mastodon](https://mastodon.social/@martasbgcorner/116575178864013914)** et **[Facebook](https://www.facebook.com/profile.php?id=61579559053699)**.

### Liens Utiles

- [Ancient Knowledge sur BoardGameGeek](https://boardgamegeek.com/boardgame/338093/ancient-knowledge)
- [Ancient Knowledge: Heritage sur BoardGameGeek](https://boardgamegeek.com/boardgame/404354/ancient-knowledge-heritage)
- [Page officielle Iello](https://iellogames.com/games/ancient-knowledge/)

### Videos

- [ANCIENT KNOWLEDGE HERITAGE - Grandeur ou Décadence ? - Partie SOLO & AVIS](https://youtu.be/RvaXCkVmia8?si=tVs007OHbJPAhK5w) - Partie en solo par Zeugma en Solo
- [Ancient knowledge in about 3 minutes](https://youtu.be/LnSWaVxm25o?si=ZtDkZv-GjDSLICG7) - Présentation du jeu par 3 Minute Board Games
- [Ancient Knowledge: Heritage - Straight Up Solo with John LaRuffa](https://youtu.be/fb18nNCHiAc?si=nohFevLjOPcFXWFi) - Partie solo par John LaRuffa